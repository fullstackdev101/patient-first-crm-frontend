...
// Type definition for team report data
...
export default function TeamWiseReport() {
    const [reportData, setReportData] = useState<TeamReportData[]>([]);
    ...
    const fetchReportData = async () => {
        try {
            ...
            const response = await axios.get('/reports/team-wise');
            ...
            console.error('Error fetching team-wise report:', err);
                ...
                <div className="main-content">
                    ...
                    <main className="content">
                        <div className="page-header" style={{ marginBottom: '24px' }}>
                            <div>
                                <h2 className="page-title">Team-wise Report</h2>
                                <p className="page-subtitle">Performance Overview by Team</p>
                            </div>
                        </div>
                            ...
                            <>
                                ...
                                <div className="metrics-grid" style={{ marginBottom: '24px' }}>
                                    <div className="card" style={{ padding: '20px' }}>
                                        ...
                                        <div style={{ fontSize: '12px', color: 'var(--gray-500)', marginTop: '4px' }}>All Teams</div>
                                    </div>
