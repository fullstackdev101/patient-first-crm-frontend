...
// Type definition for daily report data
                    ...
                    <main className="content">
                        <div className="page-header" style={{ marginBottom: '24px' }}>
                            <div>
                                ...
                                <p className="page-subtitle">Last 10 Days Performance Overview</p>
                            </div>
                        </div>
                            ...
                            <>
                                ...
                                <div className="metrics-grid" style={{ marginBottom: '24px' }}>
                                    <div className="card" style={{ padding: '20px' }}>
                                        ...
                                        <div style={{ fontSize: '12px', color: 'var(--gray-500)', marginTop: '4px' }}>Last 10 Days</div>
                                    </div>
                                    ...
                                    <div className="card" style={{ padding: '20px' }}>
                                        ...
                                        <div style={{ fontSize: '12px', color: 'var(--gray-500)', marginTop: '4px' }}>
                                            {((totals.rejected / totals.totalLeads) * 100).toFixed(1)}%
                                        </div>
                                    </div>
